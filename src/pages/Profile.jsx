...
const RARITY_CONFIG = {
  common:    { color: 'var(--rarity-common)', glow: 'rgba(139,154,179,0.3)', label: 'COMÚN' },
  rare:      { color: 'var(--rarity-rare)',   glow: 'rgba(51,209,255,0.3)',  label: 'RARA' },
  epic:      { color: 'var(--rarity-epic)',   glow: 'rgba(124,92,255,0.35)', label: 'ÉPICA' },
  legendary: { color: 'var(--rarity-legendary)', glow: 'rgba(245,196,81,0.4)', label: 'LEGENDARIA' },
};

// Custom stat bar for profile
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        borderRadius: 3,
        padding: badge.unlocked ? '2px 6px' : '0',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          height: 200,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(51,209,255,0.08) 0%, transparent 70%)',
          pointerEvents: 'none',
        }} />
        ...
        <div style={{ position: 'relative', display: 'flex', gap: 32, alignItems: 'flex-start' }}>
          ...
          <div style={{ position: 'relative', flexShrink: 0 }}>
            ...
            <div style={{
              ...
              boxShadow: '0 0 20px var(--violet-glow), inset 0 0 20px rgba(124,92,255,0.1)',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 20, marginBottom: 20 }}>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                <span style={{
                  ...
                  color: 'var(--text)',
                  lineHeight: 1,
                  textShadow: '0 0 30px rgba(124,92,255,0.4)',
                }}>
                  {currentUser.level}
                </span>
                <span style={{
            ...
            <div style={{ maxWidth: 480 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                <span style={{
                  ...
                  Nivel {currentUser.level} → {currentUser.level + 1}
                </span>
                <span style={{
                  fontFamily: 'var(--font-mono)',
                  fontSize: 11,
                  ...
                  {currentUser.xp.toLocaleString()} / {currentUser.xpNext.toLocaleString()} XP
                </span>
              </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 20 }}>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            <ProfileStat
              label="SALUD"
              value={currentUser.stats.health.value}
              color="var(--green)"
              icon={Shield}
            />
            <ProfileStat
              label="DINERO"
              value={currentUser.stats.money.value}
              color="var(--gold)"
              icon={DollarSign}
            />
            <ProfileStat
              label="DISCIPLINA"
              value={currentUser.stats.discipline.value}
              color="var(--violet)"
              icon={Zap}
            />
          </div>
