// Mock data — shape mirrors what Supabase will return.
// When integrating Supabase, replace these with real queries.
...
export const dailyMissions = [
  {
    ...
    description: 'Completa 45 min de entrenamiento de pesas',
    xp: 150,
    attribute: 'health',
    rarity: 'rare',
    completed: false,
  ...
  {
    id: 'm2',
    name: 'Lectura de inversiones',
    description: 'Lee 30 páginas de un libro financiero',
    xp: 100,
    attribute: 'money',
    rarity: 'common',
    completed: true,
  ...
  },
  {
    ...
    description: 'Medita 15 minutos al despertar',
    xp: 80,
  ...
  {
    id: 'm4',
    name: 'Sprint de productividad',
    description: 'Trabajo enfocado sin distracciones por 3 horas',
    xp: 250,
    attribute: 'discipline',
    rarity: 'epic',
    completed: false,
...
export const allMissions = [
  ...dailyMissions,
  {
    ...
    description: 'Completa 16 horas de ayuno',
    xp: 120,
    attribute: 'health',
    rarity: 'rare',
    completed: false,
  ...
  },
  {
    id: 'm6',
    name: 'Ahorra $100',
    description: 'Guarda $100 sin gastos innecesarios',
    xp: 200,
    attribute: 'money',
    rarity: 'epic',
    completed: false,
  ...
  {
    id: 'm7',
    name: 'El Desafío Legendario',
    description: 'Completa las 5 misiones épicas en un día',
    xp: 1000,
    attribute: 'discipline',
    rarity: 'legendary',
    completed: false,
  ...
  },
  {
    ...
    description: 'Bebe 3L de agua a lo largo del día',
    xp: 50,
    attribute: 'health',
    rarity: 'common',
    completed: false,
  ...
  },
  {
    ...
    description: 'No uses redes sociales por 24 horas',
    xp: 180,
    attribute: 'discipline',
    rarity: 'rare',
    completed: false,
  ...
  },
  {
    ...
    description: 'HIIT de 20 minutos a máxima intensidad',
    xp: 130,
    attribute: 'health',
    rarity: 'rare',
    completed: false,
